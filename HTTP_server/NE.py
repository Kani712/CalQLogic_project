...
class NamedEntityExtraction:
    def __init__(self, text, providers):
        ...
        self.url = "https://api.edenai.run/v2/text/named_entity_recognition"
    ...
    def analyze(self):
        ...
        for provider in self.providers:
            ...
            print(f"\n{provider}")
            # print("\n", dict(list(result[provider].items())[
            #   0:-1] + list(result[provider]['items'][0].items())), '\n')
...
sa = NamedEntityExtraction(text, providers)
